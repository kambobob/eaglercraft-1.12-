...
import com.isacofff.clientbase.ModToggles;
    ...
    private float getFOVModifier(float partialTicks, boolean useFOVSetting)
    {
        ...
        else
        {
            ...
            if (this.mc.currentScreen == null)
            {
                ...
                flag = GameSettings.isKeyDown(this.mc.gameSettings.ofKeyBindZoom) || ModToggles.isZoomEnabled();
            }
        ...
        if (this.lightmapUpdateNeeded)
        {
            ...
            if (world != null)
            {
                ...
                for (int i = 0; i < 256; ++i)
                {
                    ...
                    // FullBright: force the lightmap to maximum brightness.
                    if (ModToggles.isFullBright())
                    {
                        f8 = 1.0F;
                        f9 = 1.0F;
                        f10 = 1.0F;
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            else
            {
                ...
                if (!this.mc.gameSettings.hideGUI || this.mc.currentScreen != null)
                {
                    ...
                    // Client-side mod toggle overlay.
                    ModToggles.renderOverlay(this.mc);
                }
